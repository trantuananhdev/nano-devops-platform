...
## Task PENDING hiện tại (T-45)
**T-45: Formal Status Transitions & Workflow (BE)**
- **Mục tiêu**: Thêm quy trình chuyển đổi trạng thái chính thức cho tờ trình
...
- **Files cần chỉnh sửa**:
  ...
  - `hdtv-ai-platform/app/routers/dossiers.py`: thêm endpoints thay đổi status
