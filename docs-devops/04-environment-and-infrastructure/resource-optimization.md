...
**Core Infrastructure**: ~1.5GB
- Traefik: 150MB
- PostgreSQL: 1GB
- Redis: 200MB (128MB maxmemory)
- Socket Proxy: 50MB
...
- Loki: 300MB
- Jaeger: 300MB
- Exporters & cAdvisor: ~200MB

**Application Services**: ~1.5GB
- Odoo 16: 600MB
- health-api: 100MB
- data-api: 150MB
- aggregator-api: 150MB
- user-api: 200MB
- Headroom for growth: ~300MB

**System & Buffer**: ~1.5GB
- Alpine Linux OS: ~200MB
- ZRAM (Compressed Swap): ~1GB effective
- System headroom: ~300MB
